...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob", "bob@gmail.com", new DateTime(1998, 4, 15), 1000.0, d1);
            Seller s2 = new Seller(2, "Mari", "maria@gmail.com", new DateTime(1994, 9, 15), 1500.0, d2);
            Seller s3 = new Seller(3, "Alex", "alex@gmail.com", new DateTime(2002, 10, 5), 2200.0, d3);
            Seller s4 = new Seller(4, "Martha", "martha@gmail.com", new DateTime(1993, 9, 15), 1600.0, d1);
            Seller s5 = new Seller(5, "Donald", "donald@gmail.com", new DateTime(1990, 10, 15), 3300.0, d3);
            Seller s6 = new Seller(6, "Pink", "pink@gmail.com", new DateTime(2000, 1, 15), 1800.0, d2);
